...
import br.com.dfdevforge.sisfintransaction.statement.model.statement.entities.StatementEntityYaml;
...
import br.com.dfdevforge.sisfintransaction.statement.model.statementitem.services.StatementItemExecuteRegistrationService;
...
//			new NgcExtratoImportarFormatoCsv(this.statement, this.connectionManager).execute()
	...
	private void invocarRegraImportarFormatoYaml() throws IOException, BaseException {
		...
		StatementEntityYaml yamlStatementEntity = mapper.readValue(this.statementByteArray, StatementEntityYaml.class);
