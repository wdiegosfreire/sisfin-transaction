...
public class ObjectiveMovementAccessRegistrationService extends ObjectiveMovementBaseService implements CommonService {
	...
	@Autowired
	public ObjectiveMovementAccessRegistrationService(AccountRepository accountRepository, LocationRepository locationRepository, PaymentMethodRepository paymentMethodRepository) {
