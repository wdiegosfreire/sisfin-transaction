...
@Repository
public class SummaryRepositorySelectTotalPreviousByBalanceAccount extends BasePersistence {
	private final EntityManager entityManager;

	public SummaryRepositorySelectTotalPreviousByBalanceAccount(EntityManager entityManager) {
